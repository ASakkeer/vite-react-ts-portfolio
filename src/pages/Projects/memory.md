...
- **2026-01-21**: Removed the top demo links section entirely; all CTAs (Live Demo, Case Study, GitHub Repo) now appear exclusively within project cards. Completed projects show primary "Live Demo" + secondary "Case Study" or "GitHub Repo" buttons. In-progress projects show a single disabled "Preview" button. This ensures a single, clear interaction path per project with no duplicated navigation.
